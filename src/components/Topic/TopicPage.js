...
const TopicPage = ({topicPage, topicPhotos}) => {

    const conImage = topicPage && topicPage?.top_contributors
        ...
        <Container>
            <TopicDesc>
                <div className="textArea">
                    ...
                    <p dangerouslySetInnerHTML={{__html:topicPage?.description}}>
            ...
            <PhotoList data={topicPhotos} width={1300}></PhotoList>
        </Container>
