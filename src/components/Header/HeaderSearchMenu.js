    ...
    return(
        ...
        <Container>
            <div className="contents">
                    <div className="photos" onClick={()=>{
                        history.push(`/search/photos/${id}`)
                    }}>
                        <svg width="16" height="16" className="DhJsa" version="1.1" viewBox="0 0 32 32" aria-hidden="false">
                            <path
                                d="M26.7 4H5.3C4.5 4 4 4.5 4 5.3v21.3c0 .9.5 1.4 1.3 1.4h21.3c.8 0 1.3-.5 1.3-1.3V5.3c.1-.8-.4-1.3-1.2-1.3zm-20 20l4.7-6 3.3 4 4.7-6 6 8H6.7z"></path>
                        </svg>
                        <p>
                            Photos
                        </p>
                    ...
                    <div className="collections" onClick={()=>{
                        history.push(`/search/collections/${id}`)
                    }}>
                        <svg width="16" height="16" className="DhJsa" version="1.1" viewBox="0 0 32 32" aria-hidden="false">
                            <path
                    ...
                    <div className="users" onClick={()=>{
                        history.push(`/search/users/${id}`)
                    }}>
                    <svg width="16" height="16" className="DhJsa" version="1.1" viewBox="0 0 32 32" aria-hidden="false">
                        <path
                            d="M30.67 22.67v4h-5.34v-4a6.21 6.21 0 00-3.1-5.16c3.68.49 8.44 2.25 8.44 5.16zM12 16a5.34 5.34 0 10-5.33-5.33A5.33 5.33 0 0012 16zm8 0a5.34 5.34 0 000-10.67 5.72 5.72 0 00-1.77.32 8 8 0 010 10A5.44 5.44 0 0020 16zm-8 1.33c-3.56 0-10.67 1.79-10.67 5.34v4h21.34v-4c0-3.55-7.11-5.34-10.67-5.34z"></path>
                    </svg>
                    <p>
                        Users
                    </p>
